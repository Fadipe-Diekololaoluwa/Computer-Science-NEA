...
namespace Gymory
{
    ...
    {      
        ...
        {
            hitext.Text = LoggedInUser.FullName;
            LoadUpcomingClasses();
            LoadStats();
            LoadAttendedClassChart();
        }
        ...
        private void LoadUpcomingClasses()
        {
            try
            {
                string connectionString = @"Data source=""C:\Users\S241159\OneDrive - Altus Education Partnership\Computer Science\NEA\Nea Code\Gymory\Gymory\bin\Nea.db""";
        ...
        private void LoadAttendedClassChart()
        {
            try
            {
                string connectionString = @"Data source=""C:\Users\S241159\OneDrive - Altus Education Partnership\Computer Science\NEA\Nea Code\Gymory\Gymory\bin\Nea.db""";
                ...
                using (SQLiteDataAdapter dt = new SQLiteDataAdapter(command))
                {
                    ...
                    var series = AtdnClass.Series.Add("Attended Classes");
